    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow swipe-container" style={{ background: "var(--black)" }}>
        ...
        <div className="swipe-section" id="hacemos-slide-0">
          <div className="outer">
            <div className="inner">
              <QueHacemosHero isActive={isLargeScreen ? activeSlide === 0 : seenSlides.includes(0)} />
            </div>
          </div>
        </div>
        ...
        <div className="swipe-section" id="hacemos-slide-1">
          <div className="outer">
            <div className="inner">
              <MisionVision isActive={isLargeScreen ? activeSlide === 1 : seenSlides.includes(1)} />
            </div>
          </div>
        </div>
        ...
        <div className="swipe-section" id="hacemos-slide-2">
          <div className="outer">
            <div className="inner">
              <MonumentalSystems isActive={isLargeScreen ? activeSlide === 2 : seenSlides.includes(2)} />
            </div>
          </div>
        </div>
